		<?php
				...
				$destinataire = "thejellybeannebula@gmail.com"; // input your email here
				$objet = "Newsletter subscription from your < site name >"; // input your domain name here

				//Headers
	      $headers = array(
	                      'Content-type' => 'text/html',
	                      'From' => 'thejellybeannebula@gmail.com', // input your email from here
	                      'X-Mailer' => 'PHP/' . phpversion()
	                  );

				// Send the message then return data to current page with ajax
				if ($checkRobot == 7) {
					$conf = ini_set('mail', 'thejellybeannebula@gmail.com'); // update yours informations here
