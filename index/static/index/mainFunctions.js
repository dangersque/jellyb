...
window.addEventListener("load", function () {
  if (document.getElementById('insertMail')) {
    let name = "thejellybeannebula" ; // Update yours informations here
...
// Locations
$(function () {
    $(".card").on('click', () => {window.location.href = "https://thejellybeannebula.bandcamp.com/releases"});
})
// Location socials
$(function () {
    $('.facebook').on('click', function(event) {
      event.preventDefault();
      window.location.href = "https://www.facebook.com/thejellybeannebula";
    });
    $('.instagram').on('click', function(event) {
      event.preventDefault();
      window.location.href = "https://www.instagram.com/thejellybeannebula/";
    });
    $('.tiktok').on('click', function(event) {
      event.preventDefault();
      window.location.href = "https://www.tiktok.com/@thejellybeannebula";
    });
    $('.youtube').on('click', function(event) {
      event.preventDefault();
      window.location.href = "https://www.youtube.com/channel/UCuDQeEzpZ-_BN2nL1KTG7kA";
    });
    $('.bandcamp').on('click', function(event) {
      event.preventDefault();
      window.location.href = "https://thejellybeannebula.bandcamp.com/releases";
    });
    $('.twitter').on('click', function(event) {
      event.preventDefault();
      window.location.href = "https://twitter.com/jellybeannebula";
    });
})
